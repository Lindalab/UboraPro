<?php
require("../functions/getAllTicket.php"); 
?> 
<!DOCTYPE html>
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-white u-header" id="sec-ef51"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-b8f2">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">Ticket Packages</h1>
        ...
        <div class="u-form u-form-1">
          <form action="./../actions/tickets_action/add_ticket.php" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;" method="POST" enctype="multipart/form-data">
            <!-- <div class="u-form-group u-form-name">
              <label for="name-098e" class="u-label">Name of ticket</label>
            ...
            <div class="u-form-email u-form-group">
              <label for="email-098e" class="u-label">Ticket Status</label>
              <input type="text" placeholder="Active or Inactive" id="email-098e" name="ticket_status" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-form-group u-form-message">
              <label for="message-7f20" class="u-label">Ticket Type </label>
              <input type="number" placeholder="Enter ticket Price" id="email-098e" name="ticket_type" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
              
            </div>
            <div class="u-form-email u-form-group">
              <label for="email-098e" class="u-label">Price</label>
              <input type="number" placeholder="Enter price in cedis" id="email-098e" name="ticket_price" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-form-group u-form-message">
              <label for="message-098e" class="u-label">Ticket description</label>
              <textarea placeholder="Enter description" rows="4" cols="50" id="message-098e" name="ticket_description" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""></textarea>
            </div>

            <div class="u-form-email u-form-group">
              <label for="email-098e" class="u-label">Valid Date</label>
              <input type="date" placeholder="Enter price in cedis" id="email-098e" name="valid_period" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-align-left u-form-group u-form-submit">
              
              <input type="submit" value="Add Ticket" class="u-btn u-btn-submit u-button-style">
            </div>
