    ...
    <section class="u-clearfix u-section-1" id="sec-8dc7">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-align-left u-form u-form-1">
          <form action="./../actions/awards_action/add_award.php" class="u-clearfix u-form-spacing-50 u-form-vertical u-inner-form" source="email" name="form" style="padding: 45px;" method="POST" enctype="multipart/form-data">
            <div class="u-form-group u-form-name">
              <label for="name-7f20" class="u-label">Category Name</label>
              <input type="text" placeholder="Enter category" id="name-7f20" name="award_name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-form-group u-form-message">
              <label for="message-7f20" class="u-label">Category Description</label>
              <textarea placeholder="Enter category description" rows="4" cols="50" id="message-7f20" name="award_description" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""></textarea>
            </div>
            <div class="u-form-group u-form-message">
