        ...
        <div class="u-form u-form-1">
          <form action="https://forms.nicepagesrv.com/Form/Process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-input-layout-horizontal u-form-radiobutton u-label-top u-form-group-1">
              <label class="u-label u-spacing-0 u-label-1">Vote for Rising star</label>
              <div class="u-form-radio-button-wrapper">
                <div class="u-input-row">
                  <input type="radio" name="radiobutton" value="Eric" required="required">
                  <label class="u-label" for="radiobutton">Eric</label>
                </div>
                <div class="u-input-row">
                  <input type="radio" name="radiobutton" value="Linda" required="required">
                  <label class="u-label" for="radiobutton">Linda</label>
                </div>
                <div class="u-input-row">
                  <input type="radio" name="radiobutton" value="Dave" required="required">
                  <label class="u-label" for="radiobutton">Dave</label>
                </div>
                <div class="u-input-row">
                  <input type="radio" name="radiobutton" value="Carol" required="required">
                  <label class="u-label" for="radiobutton">Carol</label>
                </div>
              </div>
            </div>
        ...
        <div class="u-form u-form-2">
          <form action="https://forms.nicepagesrv.com/Form/Process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-input-layout-horizontal u-form-radiobutton u-label-top u-form-group-3">
              <label class="u-label u-spacing-0 u-label-6">Vote for Community Outreach</label>
              <div class="u-form-radio-button-wrapper">
                <div class="u-input-row">
                  <input type="radio" name="radiobutton" value="Eric" required="required">
                  <label class="u-label" for="radiobutton">Eric</label>
        ...
        <div class="u-form u-form-3">
          <form action="https://forms.nicepagesrv.com/Form/Process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-input-layout-horizontal u-form-radiobutton u-label-top u-form-group-5">
              <label class="u-label u-spacing-0 u-label-11">Vote for Sportsman of the year</label>
              <div class="u-form-radio-button-wrapper">
                <div class="u-input-row">
                  <input type="radio" name="radiobutton" value="Eric" required="required">
                  <label class="u-label" for="radiobutton">Eric</label>
