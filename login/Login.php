      ...
      <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1">
        ...
        <div class="u-custom-menu u-nav-container">
          <ul class="u-nav u-unstyled u-nav-1">
            ...
            <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Tickets.html" target="_blank" style="padding: 10px 20px;">Tickets</a>
            </li>
            <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Voting.html" target="_blank" style="padding: 10px 20px;">Voting</a>
            </li>
          </ul>
        </div>
          ...
          <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
            <div class="u-inner-container-layout u-sidenav-overflow">
              ...
              <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                ...
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="Tickets.html" target="_blank">Tickets</a>
                </li>
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="Voting.html" target="_blank">Voting</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <section class="u-clearfix u-section-1" id="sec-9d3f">
    <div class="u-clearfix u-sheet u-sheet-1">
      ...
      <div class="u-form u-form-1">
        <form action="login_process.php" method="POST" class="u-clearfix u-form-spacing-50 u-form-vertical u-inner-form" source="url" name="form" id="log-form" style="padding: 50px;" data-parsley-validate="">
          ...
          <div class="u-align-left u-form-group u-form-submit">
            <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-hover-palette-2-base">Submit</a>
